...
GroundRenderer::GroundRenderer(Shader& shader, std::vector<float>& vertices)
{
...
void GroundRenderer::Draw(glm::vec3 position, glm::vec3 size, float rotate, glm::vec3 color)
{
	this->m_shader.Use();
...
void GroundRenderer::InitRenderData()
{
	uint32_t vbo;
